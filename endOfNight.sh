#!/bin/bash
#Phim edited 20190609 for OneDrive Uploads
# 20190812: Setting temps during high levels of processing

echo '84' > /Scripts/temp.txt
...
if [[ $KEOGRAM == "true" ]]; then
	...
	#Phim edited 20190609 for OneDrive Uploads
	/usr/bin/rclone copy /home/pi/allsky/images/$LAST_NIGHT/keogram/keogram-$LAST_NIGHT.jpg 18:/C-Archives/Astronomy/50-Bloggables/AllskyAstroPiresults/
...
if [[ $STARTRAILS == "true" ]]; then
	...
	#Phim edited 20190609 for OneDrive Uploads
	/usr/bin/rclone copy /home/pi/allsky/images/$LAST_NIGHT/startrails/startrails-$LAST_NIGHT.jpg 18:/C-Archives/Astronomy/50-Bloggables/AllskyAstroPiresults/
...
if [[ $TIMELAPSE == "true" ]]; then
	...
	#Phim edited 20190609 for OneDrive Uploads
	/usr/bin/rclone copy /home/pi/allsky/images/$LAST_NIGHT/allsky-$LAST_NIGHT.mp4 18:/C-Archives/Astronomy/50-Bloggables/AllskyAstroPiresults/
	echo -e "\n"
fi
